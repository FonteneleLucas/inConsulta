            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                        ...
                        <?php 
                            ...
                            $query = "SELECT p.*, f.* FROM Pessoa AS p, Medico AS f WHERE f.id=$id AND f.Pessoa_id=p.id";
                                ...
                                <div class="col-lg-12">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            ...
                                            <div class="row paddingOneTop">
                                                <div class="col-md-3">
                                                    <label id="idFuncionario">CRM:</label>
                                                    <input name="matricula"  value=' . $row['crm'] . '  class="form-control" placeholder="xxxx-xx" required>
                                                </div>
