                                            ...
                                            foreach ($data2 as $row2) {
                                                echo '<tr class="odd gradeX">
                                                    ...
                                                    <td class="text-right" colspan="1">
                                                        ...
                                                        <a href="editMed.php?id='. $row2['id'] .'&idPessoa=' . $row2['Pessoa_id'].'" class="btn btn-primary">Editar</a>
                                                        <input type="submit" class="btn btn-danger" name="remover" value="Remover">
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <?php 
                                            ...
                                            $stmt = "SELECT p.*, f.* FROM Pessoa AS p, Funcionario AS f, 
                                                     Medico AS m WHERE f.Pessoa_id=p.id";
                
                                            $data = $pdoConnect->query($stmt);
                                            ...
                                            foreach ($data as $row) {
                                                echo '<tr class="odd gradeX">
                                                    ...
                                                    <td class="text-right" colspan="1">
                                                        <!--<a href="viewFuncionario.php" class="btn btn-success">Visualizar</a>-->
                                                        <a href="editFuncionario.php?id='. $row['id'] .'&idPessoa=' . $row['Pessoa_id'].'" class="btn btn-primary">Editar</a>
                            ...
                            <?php 
                                            ...
                                            if(isset($_POST['remover'])){
                                                ...
                                                $pdoQuery = "UPDATE `Funcionario` SET `ativo`=:ativo WHERE id=$id_Pessoa";
                                                $pdoResult = $pdoConnect->prepare($pdoQuery);
                                                $pdoExec = $pdoResult->execute(array(":ativo"=>0)); 
