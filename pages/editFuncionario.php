            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                        ...
                        <?php 
                            ...
                            $query = "SELECT p.*, f.* FROM Pessoa AS p, Funcionario AS f WHERE f.id=$id AND f.Pessoa_id=p.id";
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <div class="row paddingOneTop">
                                                <div class="col-md-3">
                                                    ...
                                                    <input name="matricula"  value=' . $row['matricula'] . '  class="form-control" placeholder="xxxx-xx" required>
                                                </div>
